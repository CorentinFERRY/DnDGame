...
public class DiceTest {
    ...
    public static void testConstructorAndGetter(){
        try{
            ...
            Dice d6 = new Dice(6);
            if(d6.getNbrFaces() != 6 ) throw new AssertionError("Getter faces échoué");
            Dice d20 = new Dice(20);
            if(d20.getNbrFaces() != 20) throw new AssertionError("Getter faces échoué");
            // Test valeur de dé bizarre
            Dice d100 = new Dice(100);
            if(d100.getNbrFaces() != 100) throw new AssertionError("Getter faces échoué");
    ...
    public static void testRollBounds(){
        try {
            ...
            for (int i = 0; i < iterations; i++){
                int result = d6.roll();
                if(result < 1 || result > 6) throw new AssertionError("Le dé a retourné " + result + "(inférieur à 1) au lancer n°" + i);
            }
            // On test le d20 de la même manière
            Dice d20 = new Dice(20);
            for (int i = 0; i < iterations; i++){
                int result = d20.roll();
                if(result < 1 || result > 20) throw new AssertionError("Le dé a retourné " + result + "(inférieur à 1) au lancer n°" + i);
            }
    ...
    private static void testToString() {
        try {
            ...
            if (!s.contains("6")) throw new AssertionError("ToString ne contient pas le nombre de faces");
            if (!s.contains("Dé")) throw new AssertionError("ToString ne contient pas 'Dé'");
            if (!s.contains("faces")) throw new AssertionError("ToString ne contient pas 'faces'");
